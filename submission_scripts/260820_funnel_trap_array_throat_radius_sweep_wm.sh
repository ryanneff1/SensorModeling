...
#SBATCH --job-name=260820_funnel_trap_array_throat_radius_sweep
...
GEOMETRY_JSON="${PROJECT_DIR}/configs/funnel_trap_array_throat_radius_sweep_geometry.json"
OUTPUT_ROOT="${PROJECT_DIR}/results/260820_funnel_trap_array_throat_radius_sweep"
