...
#SBATCH --job-name=260818_nanospike_branch_segments_sweep
...
GEOMETRY_JSON="${PROJECT_DIR}/configs/nanospike_branches_per_segment_sweep_geometry.json"
OUTPUT_ROOT="${PROJECT_DIR}/results/260818_nanospike_branches_per_segment_sweep"
