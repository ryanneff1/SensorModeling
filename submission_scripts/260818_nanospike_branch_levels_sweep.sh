...
#SBATCH --job-name=260818_nanospike_branch_levels_sweep
...
GEOMETRY_JSON="${PROJECT_DIR}/configs/nanospike_branch_levels_sweep_geometry.json"
OUTPUT_ROOT="${PROJECT_DIR}/results/260818_nanospike_branch_levels_sweep"
